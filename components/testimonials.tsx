      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {testimonials.map((testimonial, index) => (
            <Card
              key={index}
              className="p-8 hover:shadow-2xl hover:shadow-primary/30 transition-all duration-700 cursor-pointer group hover-lift-3d glass-effect relative overflow-hidden border-2 hover:border-primary/40"
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-base text-foreground leading-relaxed mb-8 italic">{testimonial.quote}</p>

                <div className="flex items-center gap-4">
                  <img
                    src={testimonial.image || "/placeholder.svg"}
                    alt={testimonial.name}
                    className="w-16 h-16 rounded-full object-cover border-2 border-primary/20 group-hover:scale-110 transition-transform duration-500"
                  />
                  <div>
