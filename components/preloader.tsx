    ...
    <div className="fixed inset-0 z-[9999] overflow-hidden">
      ...
      {!isRevealing && (
        <div className="absolute inset-0 z-10 pointer-events-none">
          {/* Main spotlight center - scales based on screen size */}
          ...
          {/* Top light beam - responsive width */}
          ...
          {/* Floor pool of light - responsive dimensions */}
          ...
          {/* Floating dust particles - responsive container */}
            ...
            {particles.map((particle) => (
              <div
                ...
                style={{
                  ...
                  boxShadow: "0 0 6px rgba(255, 240, 180, 0.9), 0 0 12px rgba(255, 230, 150, 0.5)",
                  filter: "blur(0.5px)",
                }}
              />
            ))}
          ...
          >
            <div
              ...
              style={{ transform: "translateX(-60px) rotate(-2deg)", boxShadow: "0 0 6px rgba(255, 235, 160, 0.6)" }}
            />
            <div
      ...
      <div className="absolute inset-0 z-30 flex items-center justify-center perspective-container px-3 sm:px-4">
        ...
        >
          {/* Ping rings - responsive margin */}
          <div className="absolute inset-0 -m-3 sm:-m-4 md:-m-6 lg:-m-8">
          ...
          {/* Glow effect - responsive blur size */}
          <div className="absolute inset-0 -m-6 sm:-m-8 md:-m-12 lg:-m-16 blur-2xl sm:blur-3xl bg-primary/20 animate-pulse-glow opacity-60 rounded-full" />
          ...
          >
            ...
            <div className="absolute inset-0 rounded-full">
              {[...Array(4)].map((_, i) => (
                <div
                  ...
                  style={{
                    top: `${50 + 40 * Math.cos((i * Math.PI * 2) / 4)}%`,
                    left: `${50 + 40 * Math.sin((i * Math.PI * 2) / 4)}%`,
            ...
            {/* Button content - responsive typography and spacing */}
            ...
            <div className="hidden sm:block absolute -top-8 -left-8 md:-top-12 md:-left-12 w-12 h-12 md:w-16 md:h-16 bg-primary/10 rounded-full blur-2xl animate-float-slow" />
            <div
              className="hidden sm:block absolute -bottom-8 -right-8 md:-bottom-12 md:-right-12 w-14 h-14 md:w-20 md:h-20 bg-primary/15 rounded-full blur-3xl animate-float-slow"
              style={{ animationDelay: "1s" }}
            />
          </Button>

          {/* Additional decorative orbs outside button */}
          <div className="hidden sm:block absolute -top-8 -left-8 md:-top-12 md:-left-12 w-12 h-12 md:w-16 md:h-16 bg-primary/10 rounded-full blur-2xl animate-float-slow" />
          <div
            className="hidden sm:block absolute -bottom-8 -right-8 md:-bottom-12 md:-right-12 w-14 h-14 md:w-20 md:h-20 bg-primary/15 rounded-full blur-3xl animate-float-slow"
            style={{ animationDelay: "1s" }}
